...
#Comands for use docker container postgresql
#docker run --name mypostgres -e POSTGRES_PASSWORD=mypassword -p 5432:5432 -d postgres:latest
#docker exec -it mypostgres bash
#psql -U postgres
#\l    #list databases
#create database flaskpostgresql;
#\c flaskpostgresql #connect to database
#\dt #list tables
